# Source: https://github.com/Farama-Foundation/Gymnasium/blob/a910eae4ce4ee899652b17f41d5a6f6e72d51c77/gymnasium/envs/box2d/car_racing.py
...
MAX_SHAPE_DIM = (
    max(GRASS_DIM, TRACK_WIDTH, TRACK_DETAIL_STEP)
    * math.sqrt(2)
    * ZOOM
    * SCALE
)
...
class FrictionDetector(contactListener):
    def __init__(self, env, lap_complete_percent) -> None:
...
class CarRacing(gym.Env, EzPickle):
    ...
    def _render(self, mode: str):
        ...
        text = font.render(
            "%04i" % self.reward, True, (255, 255, 255), (0, 0, 0),
        )
    ...
    def _render_indicators(self, W, H):
        ...
        render_if_min(
            true_speed, vertical_ind(5, 0.02 * true_speed), (255, 255, 255),
        )
        # ABS sensors
        render_if_min(
