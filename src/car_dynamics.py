"""Source: https://github.com/Farama-Foundation/Gymnasium/blob/a910eae4ce4ee899652b17f41d5a6f6e72d51c77/gymnasium/envs/box2d/car_dynamics.py
    ...
    def draw(self, surface, zoom, translation, angle, draw_particles=True):
        ...
        if draw_particles:
            for p in self.particles:
                poly = [
                    pygame.math.Vector2(c).rotate_rad(angle) for c in p.poly
                ]
                poly = [
                    (
        ...
        for obj in self.drawlist:
            for f in obj.fixtures:
                ...
                white_poly = [
                    pygame.math.Vector2(c).rotate_rad(angle)
                    for c in white_poly
                ]
                white_poly = [
                    (
